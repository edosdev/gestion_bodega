...
<html>
	...
	<body>
		<div class="contenedor">
			...
			$producto_stock_id = $_POST['seleccionar'];
			$producto_stock_act = $_POST['stock'];
						
			$consulta_actu="UPDATE productos SET stock= stock + '$producto_stock_act' WHERE cod_producto='$producto_stock_id'" ;
			$ejecutar=mysqli_query($conexion, $consulta_actu);
	            ...
	            <form name="modificar" method="post" action="" enctype="application/x-www-form-urlencoded">
	                ...
	                <div class="campo">
	                    <label name="Seleccionar">Ingresa el código del producto que deseas modificar:</label>
			 			<input name='seleccionar-campos' type="text" required>
	                </div>
			...
			$s_producto_stock_id = $_POST['seleccionar-campos'];
			$descripcion = $_POST['descripcion'];
			$proveedor = $_POST['proveedor'];
			$fecha = $_POST['fecha'];
						
			$consulta_actu_letras="UPDATE productos SET descripcion= '$descripcion', proveedor= '$proveedor', fecha_ingreso= '$fecha'  WHERE cod_producto='$s_producto_stock_id'" ;
			$ejecutar=mysqli_query($conexion, $consulta_actu_letras);
			header('Resfresh:2');
